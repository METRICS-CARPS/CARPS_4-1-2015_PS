...
```{r}
# TOM SANITY CHECK- CONCURS WITH PREVIOUS EFFORTS
...
Our attempt to replicate the reported F-scores and Dfs failed, even though the general conclusion remained the same, in that the main effect and interaction remained significant below .001. Because the dfs are different - it must be that we are specifying the ANOVA differently to the original ANOVA, or the analysis is being performed on different data. We will check with the original authors.
